...
public class AddEmployeePUI {
    ...
    public static final String CREATE_LOGIN_DETAIL_LABEL = "css=div[class*='switch']>label";
    public static final String CREATE_LOGIN_DETAIL_CHECKBOX = "css=div[class*='switch'] input";
    ...
    public static final String ENABLED_LABEL = "xpath=//label[text()='Enabled']";
